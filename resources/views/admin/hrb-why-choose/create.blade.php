{{-- resources/views/admin/hrb-why-choose/create.blade.php --}}
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form id="whyChooseForm"
                          ...
                          action="{{ route('admin.hrb-why-choose.store') }}">
...
<script>
    ...
    document.getElementById('whyChooseForm').addEventListener('submit', function ()
    {
