        ...
        <div class="content-wrapper pb-4">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.hi-style.intro.update') }}">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <textarea name="intro_content" rows="6"
                                class="form-control">{{ old('intro_content', $hi_style->intro_content ?? '') }}</textarea>
                        ...
                        <div class="form-group mt-3">
                            ...
                            @if(!empty($hi_style->intro_image_1))
                                ...
                                <div class="mt-3">
                                    ...
                                    <img src="{{ asset('storage/' . $hi_style->intro_image_1) }}" width="120">
                        ...
                        <div class="form-group mt-3">
                            ...
                            @if(!empty($hi_style->intro_image_2))
                                ...
                                <div class="mt-3">
                                    ...
                                    <img src="{{ asset('storage/' . $hi_style->intro_image_2) }}" width="120">
                    ...
                    {{-- ADD FEATURE FORM --}}
                    <form method="POST" action="{{ route('admin.hi-style.intro-feature.store') }}">
