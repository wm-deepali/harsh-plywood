...
<div class="main-section">
    ...
    <div class="app-content container-fluid">
        ...
        <div class="breadcrumbs-top bg-light mb-3">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active">Hi-Style Page</li>
            </ol>
        </div>
        ...
        <div class="content-wrapper pb-4">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.hi-style.update', 'hero') }}">
                        @csrf

                        <input type="text" name="heading" class="form-control mb-2" value="{{ $hero->heading ?? '' }}">

                        <input type="text" name="sub_heading" class="form-control mb-2"
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data"
                        action="{{ route('admin.hi-style.update', 'detail') }}">
                        @csrf
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data"
                        action="{{ route('admin.hi-style.update', 'detail2') }}">
                        @csrf

                        <textarea name="content" id="detail2"
                            class="form-control">{{ $detail2->content ?? '' }}</textarea>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.hi-style.aff.store') }}">
                        @csrf
                    ...
                    <div class="d-flex flex-wrap">
                        ...
                        @foreach($affiliations as $a)
                            <div id="aff{{ $a->id }}" class="text-center mr-3 mb-3">
                                ...
                                <button onclick="deleteAff({{ $a->id }})" class="btn btn-danger btn-sm mt-1">
                                    Delete
                                </button>
    ...
    <script>
        ...
        function deleteAff(id) {
            $.ajax({
                url: "/admin/hi-style-affiliation/" + id,
                type: "DELETE",
